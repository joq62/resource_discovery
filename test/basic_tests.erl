...
stop_start_tests()->
    ...
    [Node0,Node1]=lists:sort(rpc:call(Node0,rd,fetch_resources,[type1])),
    [Node0]=lists:sort(rpc:call(Node1,rd,fetch_resources,[type0])),
    [Node0,Node1]=lists:sort(rpc:call(Node2,rd,fetch_resources,[type1])),
...
normal_tests()->
    ...
    timer:sleep(3000),
    [_,_]=rpc:call(Node0,rd,fetch_resources,[type1],5000),
